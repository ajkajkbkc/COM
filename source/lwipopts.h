...
#define TCPIP_THREAD_STACKSIZE KALYKE_TCPIP_THREAD_STACKSIZE
#define TCPIP_THREAD_PRIO      KALYKE_TCPIP_THREAD_PRIO
...
//#define LWIP_PLATFORM_ASSERT(x) configASSERT(x)

#if (DAISY_MASTER_FEATURE == 1)
#define LWIP_HOOK_UNKNOWN_ETH_PROTOCOL(pbuf, netif)    daisy_ethernet_input(pbuf, netif)
#endif

#define LWIP_HOOK_IP4_ROUTE_SRC(src, dest) kalyke_ip4_route_hook(src, dest)
