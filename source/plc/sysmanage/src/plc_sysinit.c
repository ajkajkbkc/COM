...
void plc_sm_sd_init(void)
{
    ...
    /*PLC 类型*/
    SET_SD_ELEMENT_VALUE(0, gtv_DeviceConfigTable.mtv_DevInfo.mlv_DeviceTypeId);
    /*软件版本号*/
    i = FIRMWARE_IMAGE_ID;
    SET_SD_ELEMENT_VALUE(1, i);
    /*用户程序容量 K步*/
    SET_SD_ELEMENT_VALUE(2, 64);
    ...
    SET_SD_ELEMENT_VALUE(SD258, g_plc_netcfg.wan.notUseDHCP );
