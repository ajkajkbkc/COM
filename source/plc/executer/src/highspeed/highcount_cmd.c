...
static bool isSupportThisCounter(int counterNum)
{
    if (counterNum == HCOUNTER240 || counterNum == HCOUNTER241 ||
        counterNum == HCOUNTER248 || counterNum == HCOUNTER250 ||
...
static int handleCounterX000(int countno, int out_set_num, plc_run_power_flow_st *ltp_RunEnv)
{
    ...
    if(GET_POWER_FLOW(ltp_RunEnv)) // Instruction effective
    {
        ...
        if(!use_hc_attr[0].bit_use.BIT.initF)               //Judge IO initted
        {
            ...
            if(countno == HCOUNTER244)                      //C244 specially manage
            {
                cancel_capture(6, 3);
...
unsigned char f_CI_HCNT(plc_run_power_flow_st *ltp_RunEnv)
{
    ...
    if (countno < HCOUNTER236 || countno > HCOUNTER255)   //counter serial number judge
    {
    ...
    switch(countno)
    {
    case HCOUNTER236:    case HCOUNTER242:    case HCOUNTER244:     //high-counters of X000 input
    ...
    case HCOUNTER239:    case HCOUNTER243:    case HCOUNTER245:     //high-counters of X003 input
    ...
    case HCOUNTER246:    case HCOUNTER247:    case HCOUNTER249: //high-counters of X000 and X001 input
    ...
    case HCOUNTER248:    case HCOUNTER250:                                         //high-counters of X003 and X004 input
    ...
    case HCOUNTER251:    case HCOUNTER252:    case HCOUNTER254:                               //high-counters of X000 and X001 input
    ...
    case HCOUNTER253:    case HCOUNTER255:
