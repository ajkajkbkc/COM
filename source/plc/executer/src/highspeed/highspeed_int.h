...
#ifndef _HIGHSPEED_INT_H
#define _HIGHSPEED_INT_H
...
extern struct
{
    unsigned char op_mode;                              //0:对应除DHSCS,DHSCR指令;1:对应DHSZ的1段;2:对应DHSZ的2段;3:对应DHSZ的3段；    //4:对应除DHST
...
extern struct cmd_copy_str
{
    ...
    union
    {
        ...
        struct
        {
            int cmppoint;                  //DHST指令要比较的long型的数据
...
***********************************************************************/
extern void hc_X0_init(unsigned char counter_no, unsigned char init_onoff);
extern void hc_X1_init(unsigned char init_onoff);
extern void hc_X2_init(unsigned char init_onoff);
extern void hc_X3_init(unsigned char counter_no, unsigned char init_onoff);
extern void hc_X4_init(unsigned char init_onoff);
extern void hc_X5_init(unsigned char init_onoff);
extern void hc_X0X1_init(unsigned char counter_no, unsigned char init_onoff);
extern void hc_X3X4_init(unsigned char counter_no, unsigned char init_onoff);
extern void hc_AB0_init(unsigned char counter_no, unsigned char init_onoff);
extern void hc_AB1_init(unsigned char counter_no, unsigned char init_onoff);
