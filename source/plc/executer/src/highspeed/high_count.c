...
output:       no;
************************************************************************/
void hc_X0_init(unsigned char counter_no, unsigned char init_onoff)
{
    ...
    if(init_onoff == 1)                 					              //init hardware
    {
        ...
        else if(counter_no == HCOUNTER244)
        {
            //GIOPOL1 |= 0x10;                                            //X002 rising confige
            //GIOENA1 |= 0x10;                                            //enable X2 rise input interrupt
            bsp_kalyke_enable_X_interrupt(2, kGPIO_IntRisingEdge);
...
output:       no;
************************************************************************/
void hc_X3_init(unsigned char counter_no, unsigned char init_onoff)
{
    unsigned int use_unit;
    if(init_onoff == 1)                 					              //init hardware
    {
        ...
        else if(counter_no == HCOUNTER245)
        {
            //GIOPOL1 |= 0x20;                                            //X005 rising confige
...
output:       no;
************************************************************************/
void hc_X0X1_init(unsigned char counter_no, unsigned char init_onoff)
{
    unsigned int use_unit;
    if(init_onoff == 1)                 					              //init hardware
    {
...
output:       no;
************************************************************************/
void hc_X3X4_init(unsigned char counter_no, unsigned char init_onoff)
{
    unsigned int use_unit;
    if(init_onoff == 1)                 					              //init hardware
    {
...
output:       no;
************************************************************************/
void hc_AB0_init(unsigned char counter_no, unsigned char init_onoff)
{
    unsigned int use_unit;
    //GIOENA1 &= 0xFFFFFFF7;
    if(init_onoff == 1)                 					              //init hardware
    {
        ...
        bsp_kalyke_enable_X_interrupt(1, kGPIO_IntRisingEdge);
        if(counter_no == HCOUNTER252)
        {
            //GIOPOL1 |= 0x10;                                            //X002 rising confige
            //GIOENA1 |= 0x10;                                            //enable X2 rise input interrupt
            bsp_kalyke_enable_X_interrupt(2, kGPIO_IntRisingEdge);
        }
        else if(counter_no == HCOUNTER254)
        {
            //GIOPOL1 |= 0x10;                                            //X002 rising confige
            //GIOENA1 |= 0x10;                                            //enable X2 rise input interrupt
            bsp_kalyke_enable_X_interrupt(2, kGPIO_IntRisingEdge);
...
output:       no;
************************************************************************/
void hc_AB1_init(unsigned char counter_no, unsigned char init_onoff)
{
    unsigned int use_unit;
    //GIOENA1 &= 0xFFFFFFBF;                                          //disable X003 rise input interrupt
    if(init_onoff == 1)                 					              //init hardware
    {
        ...
        //HET_L15_0.memory.control_word = use_unit;                       //enable X004 rise input interrupt
        bsp_kalyke_enable_X_interrupt(4, kGPIO_IntRisingEdge);
        if(counter_no == HCOUNTER253)
        {
            //GIOPOL1 |= 0x20;                                            //X005 rising confige
            //GIOENA1 |= 0x20;                                            //enable X5 rise input interrupt
            bsp_kalyke_enable_X_interrupt(5, kGPIO_IntRisingEdge);
        }
        else if(counter_no == HCOUNTER255)
        {
            //GIOPOL1 |= 0x20;                                            //X005 rising confige
            //GIOENA1 |= 0x20;                                            //enable X005 rise input interrupt
            bsp_kalyke_enable_X_interrupt(5, kGPIO_IntRisingEdge);
