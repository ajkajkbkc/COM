/**
  ...
  * @version V0.0.1
  * @date    2019-03-19
  * @brief   PLC运行过程中错误信息定义
  ******************************************************************************
  */

#ifndef __PLC_ERROR_MSG_H
#define __PLC_ERROR_MSG_H
...
enum __PLC_EXEC_ERROR_MSG{
    ...
    ERR_SLAVE_OFFLINE       = 200,
    ERR_SLAVE_NUM_ERR       = 201,
    ERR_SLAVE_CFG_ERR       = 202,
    ERR_SLAVE_SCAN_OVER_TIME= 203,
