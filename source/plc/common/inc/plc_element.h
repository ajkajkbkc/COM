...
#define SD_ELEMENT_CNT  511
#define SM_ELEMENT_CNT  4096
#define X_ELEMENT_CNT   2048
#define Y_ELEMENT_CNT   2048
#define M_ELEMENT_CNT   16384 //16*1024
#define LM_ELEMENT_CNT  256
#define S_ELEMENT_CNT   4096
#define D_ELEMENT_CNT   8000
#define R_ELEMENT_CNT   32768 // 32*1024
#define V_ELEMENT_CNT   256
#define Z_ELEMENT_CNT   16

#define C_ELEMENT_CNT          512
#define C_ELEMENT_16_BIT_CNT   200
#define C_ELEMENT_32_BIT_CNT   312 //(C_ELEMENT_CNT - C_ELEMENT_16_BIT_CNT)

#define T_ELEMENT_CNT               512
#define T_ELEMENT_100MS_TIMER_CNT   256
#define T_ELEMENT_10MS_TIMER_CNT    128
#define T_ELEMENT_1MS_TIMER_CNT     128
...
#define SD233    233 // 第一个失联的从站号

#define SD234    234 // 主站扫描时间
#define SD235    235 // 此次菊花链扫描所消耗的时间（ms）
#define SD236    236 // 菊花链扫描最大扫描时间（ms）

/*
 SD240 ~ SD247对应通道0 ~ 7的AD值
...
#define HCOUNTER242     242 // X0增减计数，X2复位
#define HCOUNTER243     243 // X3增减计数，X5复位
#define HCOUNTER244     244 // X0增减计数，X2复位，X6启动
#define HCOUNTER245     245 // X3增减计数，X5复位，X7启动

#define HCOUNTER246     246 // X0增计数，X1减计数
#define HCOUNTER247     247 // X0增计数，X1减计数，X2复位
#define HCOUNTER248     248 // X3增计数，X4减计数，X5复位
#define HCOUNTER249     249 // X0增计数，X1减计数，X2复位，X6启动
#define HCOUNTER250     250 // X3增计数，X4减计数，X5复位，X7启动

#define HCOUNTER251     251 // X0：A相，X1：B相
#define HCOUNTER252     252 // X0：A相，X1：B相，X2复位
#define HCOUNTER253     253 // X3：A相，X4：B相，X5复位
#define HCOUNTER254     254 // X0：A相，X1：B相，X2复位，X6启动
#define HCOUNTER255     255 // X3：A相，X4：B相，X5复位，X7启动

#define HCOUNTER256     256 
#define HCOUNTER257     257 
#define HCOUNTER258     258 
#define HCOUNTER259     259 
#define HCOUNTER260     260 
#define HCOUNTER261     261 
#define HCOUNTER262     262 
#define HCOUNTER263     263 
