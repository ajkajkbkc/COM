...
#define EC_MAXSLAVE       128
#else
#define EC_MAXSLAVE       10
#endif
/** max. number of groups */
#define EC_MAXGROUP       1
...
typedef struct ec_state_status
{
   uint16  State;
   uint16  Unused;
   uint16  ALstatuscode;
...
/** PDO description structure for CA */
typedef struct ec_PDOdesc
{
   uint8   n;
   uint8   nu1;
   uint32  PDO[256];
...
extern int ecx_main_send_processdata(ecx_contextt *context, uint8 group, boolean use_overlap_io);
#ifdef __cplusplus
}
#endif
