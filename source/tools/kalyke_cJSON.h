...
extern char messigeid[32];
extern char messigetype[32];
extern char messigename[32];
extern uint32_t messigeslaveid;
extern char messigeslavename[32];
extern uint16_t messigeslaveadr;
