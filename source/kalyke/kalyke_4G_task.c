    ...
    while(1)
    {
        ...
        if (ret == 1)
        {
            ...
            if (ret_code != 0)
            {
                ...
                LOGE_4G("4G_task", "AT+QMTCONN Fail, let's try again!");
                xSemaphoreGive(g4GMutex);
                vTaskDelay(20000);
                continue;
            }
            LOGI_4G("4G_task", "AT+QMTCONN OK!");
            break;
        }
        else if (ret == 2)
        {
