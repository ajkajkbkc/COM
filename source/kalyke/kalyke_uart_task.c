...
static void GPT1_IRQHandler(void)
{
    ...
    else if (GPT_GetStatusFlags(EXAMPLE_GPT, kGPT_OutputCompare2Flag))
    {
        //LOGE("gpt", "timer2");
    ...
    else if (GPT_GetStatusFlags(EXAMPLE_GPT, kGPT_OutputCompare3Flag))
    {
        //LOGE("gpt", "timer3");
...
static void testGPT_task(void)
{
    ...
    GPT_SetOutputCompareValue(EXAMPLE_GPT, kGPT_OutputCompare_Channel1, gptFreq*4);  //4s
    //GPT_SetOutputCompareValue(EXAMPLE_GPT, kGPT_OutputCompare_Channel2, 2*gptFreq);//2s
    //GPT_SetOutputCompareValue(EXAMPLE_GPT, kGPT_OutputCompare_Channel3, 3*gptFreq);//3s
...
void uart_task(void *p_arg)
{
    ...
    #else
    memset(gtp_UartPort, 0, sizeof(gtp_UartPort));
    #endif
