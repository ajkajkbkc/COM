...
static void mux_enet1(void)
{
    ...
    // L10
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_AD_B0_15_GPIO1_IO15,        /* GPIO_B0_01 is configured as GPIO2_IO01 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    // E12
    IOMUXC_SetPinMux(
    ...
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_AD_B0_15_GPIO1_IO15,        /* GPIO_B0_01 PAD functional properties : */
...
static void mux_enet2(void)
{
    ...
    // H14
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_AD_B0_14_GPIO1_IO14,        /* GPIO_B0_00 is configured as GPIO2_IO00 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    // B11
    IOMUXC_SetPinMux(
    ...
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_AD_B0_14_GPIO1_IO14,           /* GPIO_B0_00 PAD functional properties : */
        0xB008u);                               /* Slew Rate Field: Fast Slew Rate
                                                 Drive Strength Field: R0/5
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
...
void mux_lpuart2(void)
{
    ...
    // A10, MCU_UART2_DE
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_B0_11_GPIO2_IO11,           /* GPIO_B0_11 is configured as GPIO2_IO10 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinConfig(
...
void mux_leds(void)
{
    ...
    IOMUXC_SetPinMux(
        ...
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_EMC_39_GPIO3_IO25,        /* GPIO_EMC_39 PAD functional properties : */
        0x0008u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinConfig(
      ...
      0x10B0u);                               /* Slew Rate Field: Fast Slew Rate
                                               Drive Strength Field: R0/6
                                               Speed Field: medium(100MHz)
                                               Open Drain Enable Field: Open Drain Disabled
                                               Pull / Keep Enable Field: Pull/Keeper Enabled
